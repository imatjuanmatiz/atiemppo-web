---
layout: post
title: "Cuatro proyectos para mostrar cómo estamos construyendo IA aplicada"
description: "Una pieza paraguas para presentar Bruno/OpenClaw, Novedades en Vías, El Dato Logístico y Profe Bruno como casos vivos de IA aplicada."
date: 2026-06-29 09:50:00 -0500
...
<figure>
  ...
  <figcaption>Los reportes vivos llevan el análisis a una superficie explorable: mapas, filtros, rangos, rutas y lectura ejecutiva en un mismo lugar.</figcaption>
</figure>
...
[Leer el caso El Dato Logístico](/casos/sistema-editorial-ia-el-dato-logistico/)
...
3. crear reglas de trabajo;
4. usar agentes especializados;
5. mantener memoria;
6. producir entregables;
7. revisar y mejorar con evidencia.

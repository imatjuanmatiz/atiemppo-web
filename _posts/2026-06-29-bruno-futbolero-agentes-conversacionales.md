---
layout: post
title: "Bruno Futbolero: agentes conversacionales que entienden contexto"
description: "Un laboratorio social para probar agentes con tono, memoria, datos vivos y conversación fluida en grupos reales."
...
1. se define un rol claro para el agente;
2. se conecta a canales reales de conversación;
3. se le dan fuentes y herramientas;
4. se establecen reglas de privacidad y tono;
5. se decide cuándo responde y cuándo no;
6. se prueban casos reales;
7. se ajusta el comportamiento según lo que ocurre.
